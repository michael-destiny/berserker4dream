...
package com.berserker4dream.ui.view;
...
public class SimpleMonthView extends View {
    ...
    private static final int datepicker_month_label_size = 28;
    private static final int datepicker_month_day_label_text_size = 24;
    private static final int datepicker_month_list_item_header_height = 96;
    private static final int datepicker_day_number_select_circle_radius = 32;
    private static final int datepicker_view_animator_height = 488;
    ...
    public SimpleMonthView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMonthLabelTextSize = datepicker_month_label_size;
        mMonthDayLabelTextSize = datepicker_month_day_label_text_size;
        mMonthHeaderSize = datepicker_month_list_item_header_height;
    ...
    private static final int datepicker_default_normal_text_color_holo_light = 0xff999999;
    private static final int datepicker_default_disabled_text_color_holo_light = 0x80999999;
    private static final int holo_blue_light = 0xff33b5e5;

    void setTextColor(ColorStateList colors) {
        final Resources res = getContext().getResources();

        mNormalTextColor = datepicker_default_normal_text_color_holo_light;
        mMonthTitlePaint.setColor(mNormalTextColor);
        mMonthDayLabelPaint.setColor(mNormalTextColor);

        mDisabledTextColor = datepicker_default_disabled_text_color_holo_light;
        mDayNumberDisabledPaint.setColor(mDisabledTextColor);

        mSelectedDayColor = holo_blue_light;
